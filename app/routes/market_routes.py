...
async def get_market_prices(
    ...
    limit_days: int = Query(1, ge=1, le=30, description="Number of days of price data to collect (1-30, default: 1)"),
    limit: int = Query(15, ge=1, le=100, description="Maximum number of records to return (1-100, default: 15)"),
):
    """
    ...
    - arrival_date: Starting date in dd/mm/YYYY format (default: today)
    - limit_days: Number of days to collect (1-30, default: 1)
    - limit: Maximum records to return (1-100, default: 15)
    """
    try:
